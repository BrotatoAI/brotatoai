...
func _draw():
	...
	var visuals_enabled = ModsConfigInterface.mod_configs["BaRRaK-BrotatoAI"]["ENABLE_AI_VISUALS"]
	...
	var item_weight = ModsConfigInterface.mod_configs["BaRRaK-BrotatoAI"]["ITEM_WEIGHT"]
	var projectile_weight = ModsConfigInterface.mod_configs["BaRRaK-BrotatoAI"]["PROJECTILE_WEIGHT"]
	var tree_weight = ModsConfigInterface.mod_configs["BaRRaK-BrotatoAI"]["TREE_WEIGHT"]
	var boss_weight = ModsConfigInterface.mod_configs["BaRRaK-BrotatoAI"]["BOSS_WEIGHT"]
	...
	for item in items_container.get_children():
		...
		var size = (1 / squared_distance_to_item) * circle_size_multiplier * 3
	...
	for neutral in _entity_spawner.neutrals:
		...
		var size = (1 / squared_distance_to_neutral) * circle_size_multiplier * 3
	...
	for projectile in projectiles_container.get_children():
		...
		var size = 1 / squared_distance_to_item * 1_000_000 * 3
	...
	for enemy in _entity_spawner.enemies:
		...
		var size = 1 / max(squared_distance_to_enemy, 1) * circle_size_multiplier
